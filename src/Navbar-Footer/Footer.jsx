            ...
            <div className="footer-content">
                <div className="footer-section">
                    ...
                    <div className="social-icons">
                        <div className='icons-media'> <i class="fab fa-facebook"></i><p to="/" className='a'>Facebook</p></div>
                        <div className='icons-media'> <i class="fab fa-twitter"></i>
                        <p>Twitter</p>
                    </div>    
                    <div className='icons-media'><i class="fab fa-linkedin"></i><p>Linkedin</p></div>
                 ...
                 <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><Link to="/"className='a'>A propos</Link></li>
                        <li><Link to="/"className='a'>Publier</Link></li>
                        <li><Link to="/"className='a'>Favoris</Link></li>
                 ...
                 <div class="footer-section">
                    ...
                    <div className='icons-media'><i class="fas fa-phone"></i>
